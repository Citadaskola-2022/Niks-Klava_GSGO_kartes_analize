...
<div class="isolate bg-white py-24 px-6 sm:py-32 lg:px-8">
    ...
    <form action="/dashboard/add" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <div class="relative mt-2.5">
                    <div class="absolute inset-y-0 left-0 flex items-center">
                        ...
                        <select id="map" name="map" class="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                            <option value="map_1">US</option>
                            <option value="map_2">CA</option>
                            <option value="map_3">EU</option>
                        </select>
            ...
            <div>
                <label for="kills" class="block text-sm font-semibold leading-6 text-gray-900">Kills</label>
                <div class="mt-2.5">
                    <input type="text" name="kills" id="kills" autocomplete="family-name" class="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div>
                <label for="deaths" class="block text-sm font-semibold leading-6 text-gray-900">Deaths</label>
                <div class="mt-2.5">
                    <input type="text" name="deaths" id="deaths" autocomplete="family-name" class="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
